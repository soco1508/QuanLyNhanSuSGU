...
namespace QLNS_SGU.Presenter
{
    ...
    public class MainPresenter : IMainPresenter
    {
        ...
        public static async Task LoadDataToMainGrid()
        {            
            ...
            _view.GCMain.DataSource = await unitOfWorks.GridViewDataRepository.LoadDataToMainGrid();
        }       
